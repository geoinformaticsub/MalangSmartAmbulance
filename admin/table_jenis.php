                    ...
                    <div class="row-fluid">		
                        <div class="box span12">
                            <div class="box-header" data-original-title="">
                                <h2><i class="icon-user"></i><span class="break"></span>Data Jenis Gawat Darurat </h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysql_query("SELECT * FROM gawatdarurat ORDER BY K_ID_GD ASC");
                                        $no = 1;
...
//                                            echo "</tr>";
                                ...
                                <button data-toggle="modal" href ="#myModalTambahKorban" class="btn btn-small btn-danger">Tambah Jenis GD</button>

                                <div class="modal hide fade" id="myModalTambahKorban">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                        <h3 class="modal-title">Form Tambah Jenis Gawat Darurat</h3>
                                    </div>
