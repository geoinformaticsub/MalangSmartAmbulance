                    ...
                    <div class="row-fluid">		
                        <div class="box span12">
                            <div class="box-header" data-original-title="">
                                <h2><i class="icon-user"></i><span class="break"></span>Data Korban Gawat Darurat </h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysql_query("SELECT * FROM korban ORDER BY K_ID_KORBAN ASC");
                                        $no = 1;
                                        $namafolder = "img/"; //tempat menyimpan file
                                        while ($test = mysql_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $test['K_ID_KORBAN'] . "</td>";
                                            echo "<td>" . $test['K_ID_GD'] . "</td>";
                                            echo "<td>" . $test['K_JENIS_GD'] . "</td>";
                                            ...
                                            echo "</td>";
                                            echo "<td class = 'center'><span class = 'label label-success'>" . $test['K_STATUS'] . "</span></td>";
...
//                                            echo "</tr>";
                                ...
                                <button data-toggle="modal" href ="#myModalTambahKorban" class="btn btn-small btn-danger">Tambah Korban</button>

                                <div class="modal hide fade" id="myModalTambahKorban">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                        <h3 class="modal-title">Form Tambah Korban</h3>
                                    </div>
