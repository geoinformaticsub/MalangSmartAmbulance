                    ...
                    <div class="row-fluid">		
                        <div class="box span12">
                            <div class="box-header" data-original-title="">
                                <h2><i class="icon-user"></i><span class="break"></span>Data Rumah Sakit </h2>
                                <div class="box-icon">
...
<!--                                            <th>EMAIL</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysql_query("SELECT * FROM rumahsakit ORDER BY K_ID_RS ASC");
                                        $no = 1;
                                        $namafolder = "img/"; //tempat menyimpan file
                                        while ($test = mysql_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $test['K_ID_RS'] . "</td>";
                                            echo "<td>" . $test['K_LONGITUDE'] . "</td>";
                                            echo "<td>" . $test['K_LATITUDE'] . "</td>";
                                            echo "<td>" . $test['K_NAMA_RS'] . "</td>";
                                            echo "<td>" . $test['K_JENIS_RS'] . "</td>";

                                            echo "<td>" . $test['K_DIREKTUR'] . "</td>";
                                            echo "<td>" . $test['K_ALAMAT'] . "</td>";
//                                            echo "<td>" . $test['K_DAERAH'] . "</td>";
                                            echo "<td>" . $test['K_KODE_POS'] . "</td>";
                                            echo "<td>" . $test['K_TELEPON'] . "</td>";
//                                            echo "<td>" . $test['K_FAX'] . "</td>";
//                                            echo "<td>" . $test['K_WEBSITE'] . "</td>";
                                            echo "<td>" . $test['K_KELAS'] . "</td>";
...
//                                            echo "</tr>";
                                ...
                                <button data-toggle="modal" href ="#myModalTambahKorban" class="btn btn-small btn-danger">Tambah Rumah Sakit</button>

                                <div class="modal hide fade" id="myModalTambahKorban">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                        <h3 class="modal-title">Form Tambah Rumah Sakit</h3>
                                    </div>
