                    ...
                    <div class="row-fluid">
                        <div class="box span9">
                            <div class="box-header">
                                <h2><i class="icon-font"></i><span class="break"></span>Selamat Datang !</h2>
                            </div>
                            <div class="box-content">
                                <div class="page-header">
                                    <h1>Sistem Manajemen Ambulans Kota Malang <br></h1>
                                    <img src="img/arsip-soal.png"/>
                                </div>     
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        ...
                                        <p>
                                            Proyek ini dilaksanakan untuk memenuhi tugas akhir skripsi sebagai salah satu syarat kelulusan yang diselenggarakan di Fakultas Ilmu Komputer (FILKOM) Jurusan Sistem Informasi Universitas Brawijaya. 
                                        </p>
                                    </div>
                                    <div class="span6">
                                        <h3>Deskripsi Sistem</h3>
                                        <p>
                                            Sistem Manajemen Ambulans Kota Malang merupakan sistem yang dibuat khusus untuk penanganan gawat darurat yang terjadi di Kota Malang. Sistem ini  menggunakan informasi geografis dalam menentukan solusi pencarian rute terbaik untuk mobil ambulans dalam mencapai lokasi gawat darurat dan mobilisasi korban ke pusat kesehatan terdekat.
                                    </div>
                                </div>
                                <br>
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="tooltip-demo well">
                                            <p class="muted" style="margin-bottom: 0;">
                                                Dibuat Oleh :<br>
                                                Ika Qutsiati Utami  (125150401111003)<br>
                                                <br>
                                                <br>
                                                Tanggal :<br>
                                                26 Oktober 2015 - 26 Januari 2016
                        ...
                        <div class="box span3">
                            <div class="box-header" data-original-title="">
                                <h2><i class="icon-list"></i><span class="break"></span>Daftar Fitur</h2>
                            </div>
                            <div class="box-content">
                                <ol>
                                    <li>Manajemen data korban gawat darurat</li>
                                    <li>Manajemen data ambulans</li>
                                    <li>Manajemen data jenis gawat darurat</li>
                                    <li>Manajemen data rumah sakit</li>
                                    <li>Manajemen data lampu lalu lintas</li>
                                    <li>Manajemen data kerapatan jalan</li>
                                    <li>Manajemen data kepadatan jalan</li>
                                    <li>Kalkulasi rute terbaik</li>
