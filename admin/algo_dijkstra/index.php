...
// temporary list angkot
    ...
    function initialize() {
        ...
        var mapOptions = {
            zoom: 13,
            center: new google.maps.LatLng(-7.9580944, 112.639047)
        };
...
// select option
echo 'Lokasi Korban Gawat Darurat : <select id="select_tujuan" onchange="choose_destination(this.value)">';
echo '<option value="pilih">ID Korban</option>';
...
echo '</select>';
?>
<span><button onclick="send_dijkstra()" id='run_dijkstra'>PROSES</button><span id='loading' style='display:none'>Loading ..</span></span>
