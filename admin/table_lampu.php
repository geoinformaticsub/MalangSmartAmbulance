                    ...
                    <div class="row-fluid">		
                        <div class="box span12">
                            <div class="box-header" data-original-title="">
                                <h2><i class="icon-user"></i><span class="break"></span>Data Lampu Lalu Lintas </h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysql_query("SELECT * FROM lampulalulintas ORDER BY K_ID_LLL ASC");
                                        $no = 1;
                                        while ($test = mysql_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $test['K_ID_LLL'] . "</td>";
                                            echo "<td>" . $test['K_LONGITUDE'] . "</td>";
                                            echo "<td>" . $test['K_LATITUDE'] . "</td>";
                                            echo "<td>" . $test['K_HIGHWAY'] . "</td>";
                                            echo "<td>" . $test['K_CROSSING'] . "</td>";
...
//                                            echo "</tr>";
                                ...
                                <button data-toggle="modal" href ="#myModalTambahKorban" class="btn btn-small btn-danger">Tambah Lampu Lalu Lintas</button>

                                <div class="modal hide fade" id="myModalTambahKorban">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">×</button>
                                        <h3 class="modal-title">Form Tambah Lampu Lalu Lintas</h3>
                                    </div>
